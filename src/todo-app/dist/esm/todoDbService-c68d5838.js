 ...
 *
 * Version 3.1.0-alpha.8, Fri Feb 12 2021
 *
 * http://dexie.org
 *
...
function createDBCore(db, indexedDB, IdbKeyRange, tmpTrans) {
    ...
    function createDbCoreTable(tableSchema) {
        ...
        function mutate(_a) {
            var trans = _a.trans, type = _a.type, keys$$1 = _a.keys, values = _a.values, range = _a.range;
            return new Promise(function (resolve, reject) {
                ...
                var done = function (event) {
                    ...
                    resolve({
                        ...
                        failures: failures,
                        results: type === "delete" ? keys$$1 : reqs.map(function (req) { return req.result; }),
    ...
    create: function (downCore) { return (__assign(__assign({}, downCore), { table: function (tableName) {
            ...
            var tableMiddleware = __assign(__assign({}, downTable), { mutate: function (req) {
                    ...
                    function addPutOrDelete(req) {
                        ...
                        req = req.type === 'add' || req.type === 'put' ? __assign(__assign({}, req), { keys: keys$$1 }) : __assign({}, req);
                        if (req.type !== 'delete')
...
props(RangeSet.prototype, (_a$1 = {
        ...
        addKeys: function (keys$$1) {
            var _this = this;
            keys$$1.forEach(function (key) { return addRange(_this, key, key); });
            return this;
        }
    ...
    create: function (core) {
        ...
        return __assign(__assign({}, core), { table: function (tableName) {
                ...
                var getRange = function (_a) {
                    var _b = _a.query, index = _b.index, range = _b.range;
                    var _c, _d;
                    return [
                        index,
...
class TodoAppData extends Dexie {
  constructor() {
    super("TodoAppData");
...
export { TodoAppData as T, liveQuery as l };
